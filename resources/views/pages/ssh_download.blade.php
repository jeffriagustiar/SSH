              ...
              <div class="card">
                <div class="card-header p-2">
                  <ul class="nav nav-pills">
                    <li class="nav-item"><a class="nav-link active" href="#listssh" data-toggle="tab">Download SSH</a></li>
                  </ul>
                </div><!-- /.card-header -->
                <div class="card-body">
                  <div class="tab-content">
                    <div class="active tab-pane" id="listssh">
                      ...
                      <div class="card-body pad table-responsive">
                        <form action="{{ route('ssh-download-templete') }}" method="post" enctype="multipart/form-data">
                          @csrf
