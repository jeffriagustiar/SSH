        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Pengajuan SBU</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <div class="card">
                <div class="card-header p-2">
                  <ul class="nav nav-pills">
                    <li class="nav-item"><a class="nav-link active" href="#listsbu" data-toggle="tab">List SBU</a></li>
                    <li class="nav-item"><a class="nav-link" href="#upload" data-toggle="tab">Upload SBU</a></li>
                    <li class="nav-item"><a class="nav-link" href="#listsbusah" data-toggle="tab">SBU Sah</a></li>
                    <li class="nav-item"><a class="nav-link" href="#listsbulive" data-toggle="tab">SBU Live SIPD</a></li>
                  </ul>
                </div><!-- /.card-header -->
                <div class="card-body">
                  <div class="tab-content">
                    ...
                    <div class="tab-pane" id="upload">
                        ...
                        <form action="{{ route('importSbu') }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                          @csrf
                    ...
                    <div class="tab-pane" id="listsbusah">
                      <!-- Post -->
                      <div class="card-body pad table-responsive">
                    ...
                    <div class="tab-pane" id="listsbulive">
                      <!-- Post -->
                      <div class="card-body pad table-responsive">
