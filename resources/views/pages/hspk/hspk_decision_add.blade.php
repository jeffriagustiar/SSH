        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">List HSPK</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            {{-- <div class="col-md-16"> --}}
              <div class="card">
                ...
                <div class="tab-pane" id="settings">
                    <form action="{{ route('data-hspk-add') }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                        @csrf

                        <div class="form-group row">
                            <label for="inputName" class="col-sm-2 col-form-label">Kode</label>
                            <div class="col-sm-10">
                              <input type="hidden" class="form-control" value="{{ $hspk->hspk_id }}" name='hspk_id' required>
